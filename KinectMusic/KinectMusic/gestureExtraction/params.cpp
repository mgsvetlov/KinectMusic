...
int Params::BLOB_FINGER_MAX_SIZE;
...
void Params::Init(){
    ...
    MAX_NEIGHB_DIFF_COARSE = depthFormatIndex == 0 ? 160 : 6;//80 : 4
    ...
    BLOB_EXT_RESIZE_POW = MATRIX_WIDTH == 640 ? 1 : 1;
    ...
    BLOB_EXT_FEATURE_INDS_COARSE_MIN_SIZE = (MATRIX_WIDTH >> (BLOB_EXT_RESIZE_POW * 2)) * 0.15625 * 0.5;
    BLOB_EXT_CONVEX3D_FILTER_SIZE_FINE = (MATRIX_WIDTH >> BLOB_EXT_RESIZE_POW) * 0.016;
    BLOB_EXT_CONVEX3D_FILTER_DEPTH_FINE = depthFormatIndex == 0 ? 16 : 28;
    BLOB_EXT_CONVEX3D_CORE_HALF_SIZE_FINE = 2;
    BLOB_EXT_CONVEX3D_COUNT_FALSE_PERCENT_FINE = 75;
    
    BLOB_FINGER_MAX_SIZE = (MATRIX_WIDTH >> (BLOB_EXT_RESIZE_POW *2)) * 1.5;
