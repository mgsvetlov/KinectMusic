...
void Params::Init(){
    ...
    BLOB_EXT_CONVEX3D_FILTER_SIZE_COARSE = MATRIX_WIDTH * 0.02;
    ...
    BLOB_EXT_FEATURE_INDS_COARSE_MIN_SIZE = MATRIX_WIDTH * 0.15625;
    BLOB_EXT_CONVEX3D_FILTER_SIZE_FINE = MATRIX_WIDTH * 0.01;
    BLOB_EXT_CONVEX3D_FILTER_DEPTH_FINE = depthFormatIndex == 0 ? 32 : 28;
    BLOB_EXT_CONVEX3D_CORE_HALF_SIZE_FINE = 1;
    BLOB_EXT_CONVEX3D_COUNT_FALSE_PERCENT_FINE = 38;
