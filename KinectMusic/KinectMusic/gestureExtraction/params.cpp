...
void Params::Init(){
    ...
    CONVEX3D_FILTER_SIZE = (MATRIX_WIDTH >> BLOB_RESIZE_POW) * 0.05;
    CONVEX3D_FILTER_DEPTH = (MATRIX_WIDTH >> BLOB_RESIZE_POW) * 0.1;
    CONVEX3D_CORE_HALF_SIZE = 2;
    ...
    BLOB_EXT_MAX_DEPTH_RANGE = depthFormatIndex == 0 ? 150 : 90;
